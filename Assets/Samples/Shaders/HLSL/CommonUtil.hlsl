#ifndef CATDARKGAME_SPRITE_COMMONUTIL_INCLUDED
#define CATDARKGAME_SPRITE_COMMONUTIL_INCLUDED


void SumBlur_float(TEXTURE2D_PARAM(Tex, sampler_Tex), float2 Uv0, float Power, out float3 Color, out float Alpha)
{
    Power *= 0.005;
    #define GETPIXEL(offsetx, offsety, gaussian) SAMPLE_TEXTURE2D(Tex, sampler_Tex, Uv0 + float2(offsetx * Power, offsety * Power)) * gaussian
